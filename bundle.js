...
class Board {
  ...
  closeModal() {
    ...
    $(document.getElementById("button-container-ipad")).removeClass('hiding');
  }
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.getElementById("lLeft").addEventListener("click", () => handlePress(5));
  document.getElementById("lRight").addEventListener("click", () => handlePress(8));
  document.getElementById("lUp").addEventListener("click", () => handlePress(7));
  document.getElementById("lDown").addEventListener("click", () => handlePress(6));
  document.getElementById("rLeft").addEventListener("click", () => handlePress(1));
  document.getElementById("rRight").addEventListener("click", () => handlePress(4));
  document.getElementById("rUp").addEventListener("click", () => handlePress(3));
  document.getElementById("rDown").addEventListener("click", () => handlePress(2));
